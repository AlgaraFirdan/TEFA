...
<div class="bg-white shadow rounded-lg p-6">
    ...
    <form method="POST" action="{{ route('admin.mapel.update', $mapel) }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama" id="nama" value="{{ $mapel->nama }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
        </div>
